...
tags: []
author: traysoncombs
permalink: "/pilgrimage-htb.html"
---

![](/static/img/2025/05/Pilgrimage-1024x775.png)
...
![](/static/img/2025/05/website-1024x490.png)

I got lost for a while until I decided to try something different, and I checked if the webiste was a git repo. I checked if .git existed on the server and I got a 403, perfect. From there I had to figure out how to recover the files. Apparently a tool called [gitdump](https://github.com/Ebryx/GitDump) exists for this exact purpose. I used it and was able to recover the source code which contained a binary for imagemagick which was used by the website to shrink images.
...
![](/static/img/2025/05/db-1024x386.png)
